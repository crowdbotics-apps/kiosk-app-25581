"""kiosk_app_25581 URL Configuration
...
admin.site.site_header = "kiosk APP"
admin.site.site_title = "kiosk APP Admin Portal"
admin.site.index_title = "kiosk APP Admin"

# swagger
api_info = openapi.Info(
    title="kiosk APP API",
    default_version="v1",
    description="API documentation for kiosk APP App",
)
